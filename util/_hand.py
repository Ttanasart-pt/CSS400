...
class Hand():
    ...
    def poseAnalyze(self, handPose):
        ...
        if isIndexPoint and not isMiddlePoint and not isRingPoint and not isPinkyPoint:
            self.gesture = 1
        elif isIndexPoint and isMiddlePoint and not isRingPoint and not isPinkyPoint:
            self.gesture = 2
        elif isIndexPoint and isMiddlePoint and isRingPoint and not isPinkyPoint:
            self.gesture = 3
        elif isIndexPoint and isMiddlePoint and isRingPoint and isPinkyPoint:
            self.gesture = 4